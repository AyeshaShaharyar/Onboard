...
module.exports = (db) => {
  ...
  router.get("/:employee_id/tasks", (req, res) => {
    ...
    let query = `SELECT first_name as fName, name, description, due_date, due_date - CURRENT_DATE AS pending_days,  tasks_employee.id, tasks.id, rating, completion FROM tasks_employee
