  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, bgcolor: 'background.default', p: 3 }}>
        ...
        <Divider variant='middle' textAlign="left"><Typography variant="h4">Tasks</Typography></Divider>

        <div selected className="Button">
          <Button ref={inputEl} autoFocus disableRipple variant="outlined" value={"all"} onClick={handleBtns}>
            <AssignmentIcon fontSize="small" />View All</Button>
          <Button disableRipple variant="outlined" value={"completed"} onClick={handleBtns}>
            <AssignmentTurnedInIcon fontSize="small" />Completed</Button>
          <Button disableRipple variant="outlined" value={"pending"} onClick={handleBtns}>
